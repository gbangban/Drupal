# $Id: WARNING_README_FIRST.txt,v 1.1.2.1 2010/03/21 13:15:32 kiam Exp $
#
...
[1]
If you are updating to an alpha, beta, or release candidate, test the version on
...
[2]
When you update the project files to a later version, always delete the old
...
[3]
Updating between different releases of the development snapshot of the same
branch is not supported; if you install it, you need to remove the previous
