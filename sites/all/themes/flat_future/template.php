 ...
 *   entirety and paste it here, changing the prefix from theme_ to flat_future_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: flat_future_breadcrumb()
 *
 *   where flat_future is the name of your sub-theme. For example, the
...
if (theme_get_setting('flat_future_fixed')) {
 ...
 */
function flat_future_theme(&$existing, $type, $theme, $path) {
...
function flat_future_preprocess_page(&$vars, $hook) {
  ...
  $vars['css_alt'] = flat_future_css_reorder($vars['css']);
...
if (theme_get_setting('flat_future_debug')) {
 ...
 */
function flat_future_css_reorder($css) {
  global $theme_info;
...
function flat_future_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function flat_future_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function flat_future_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function flat_future_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
